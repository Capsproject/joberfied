              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <div class="col-md-11">
                  ...
                  <div class="col-md-8">
                    <select class="form-control input-sm" name="CIVILSTATUS" id="CIVILSTATUS" any value="<?php echo $appl->CIVILSTATUS;?>" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                        <option value="<?php echo $appl->CIVILSTATUS;?>" ><?php echo $appl->CIVILSTATUS;?></option>
