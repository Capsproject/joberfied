...
<head>
<meta charset="utf-8">
<title>JOBERFIED / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs" style="color: black;"><i class="fa fa-phone" style="color: black;"></i>(043) 487 0733 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>
                <p class="pull-left hidden-xs" style="color: black;"><i class="fa fa-envelope" style="color: black;"></i>mabinibgt.peso@gmail.com</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container" style="width: 100%;">
                <div class="navbar-header">
                    ...
                    <!--<a class="navbar-brand" href="<?php echo web_root; ?>index.php">--><img class="navbar-brand"  src="/JOBERFIED/plugins/home-plugins/img/joberfiedbanner.png" alt="logo" /> </a>
                </div>
                    ...
                    <ul class="nav navbar-nav" style="float: right: margin-right: 2em;">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                       ...
                       <!-------------------------------------------------CAREER START--------------------------------------------------------------------->
                              ...
                              <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">Job Fair</a></li></li>
                       <!-------------------------------------------------CAREER END--------------------------------------------------------------------->
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          2nd Flr., Mabini Municipal Hall Poblacion, Mabini, Batangas.</address>
          <p>
            <i class="icon-phone"></i> (043) 487 0733 <br>
            <i class="icon-phone"></i> +63-917-1201369 <br>
            <i class="icon-envelope-alt"></i> mabinibgt.peso@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
